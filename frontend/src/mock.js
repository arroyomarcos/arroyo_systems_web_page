...
export const SOLUTIONS = [
  {
    ...
    description: "Engineering solutions for machined, sheet metal and welded mechanical components.",
    items: ["Concept Design", "Design Refinement", "Design Review"],
  },
  {
    id: "validation",
    title: "Structural Validation",
    description: "Engineering validation to verify structural integrity before manufacturing and operation.",
    items: ["Load Assessment", "Design Validation", "Failure Analysis"],
  },
  {
    id: "performance",
    title: "Engineering Performance",
    description: "Engineering-driven optimisation to maximise component performance and reliability.",
    items: ["Performance Optimization", "Reliability Optimization"],
  },
];
